...
const PUBLIC_PATHS = ["/login", "/signup", "/auth/callback", "/api/auth/login", "/api/auth/signup", "/api/auth/callback", "/api/auth/resend", "/api/chat", "/api/stripe/webhook", "/api/auth/logout", "/pricing", "/docs", "/privacy", "/terms", "/about"];
